...
const SolidityTest = {
  define(abstraction, dependency_paths, runner, mocha) {
    ...
    console.log("init suite");
    suite.timeout(runner.BEFORE_TIMEOUT);
    console.log("pass suite timeout");
    ...
    console.log("did beforeAll suite");
  ...
  compileNewAbstractInterface(runner, callback) {
    console.log("about to find contracts in abstractInterface");
    find_contracts(runner.config.contracts_directory, err => {
      ...
      console.log("about to compile w/ dependencies");
      ...
      console.log("done compiling w/ dependencies");
    });
  },
