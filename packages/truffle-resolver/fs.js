...
FS.prototype.getContractName = function(sourcePath, searchPath) {
  ...
  console.log("in FS getContractName");

  console.log("sourcePath:", sourcePath, "searchPath:", searchPath);
  ...
  if (path.extname(sourcePath) === ".vy")
    return path.basename(sourcePath, ".vy");
  // fallback
  else return path.basename(sourcePath, ".sol");
};
