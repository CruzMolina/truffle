const debug = require("debug")("tezos-contract:handlers"); // eslint-disable-line no-unused-vars
...
var handlers = {
  ...
  receipt: async function(context, receipt) {
    ...
    if (receipt.status !== undefined && !receipt.status) {
      var reason = await Reason.get(context.params, context.contract.adapter);
