const debug = require("debug")("tezos-contract:utils"); // eslint-disable-line no-unused-vars
...
const Utils = {
  ...
  is_tx_params(val) {
    ...
    console.log("possible txParam", val);
  ...
  getTxParams(args) {
    const expected_arg_count = 0; //methodABI ? methodABI.inputs.length : 0;
    ...
    return Utils.merge(this.class_defaults, tx_params);
  },
  ...
  async setInstanceNetworkID(
    ...
    // TODO: this will possibly throw for Tez
