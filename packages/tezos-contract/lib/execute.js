    ...
    return function() {
      ...
      execute
        ...
        .then(async ({ args, params, network }) => {
          ...
          //deferred = web3.eth.sendTransaction(testParams);
          //handlers.setup(deferred, context);
          ...
          try {
            ...
            //            const contractInstance = await web3.tez.contract.at("KT1RWT8bDfSWMDmZBhgDsyFJwheDSPs8taaB")
            contractInstance.transactionHash = receipt.hash; //"ooVK1jRMUD4fYm9e1PrVuYpNYJDHL7y4iMEWHLCZQAk1e5ngiFQ"
            ...
            //await console.log(contractInstance.methods)
            //await console.log(await contractInstance.storage())
            //            const op = await contractInstance.methods.main("0").send({ fee: 500000, gasLimit: 800000 })
