    ...
    const kinds = {
      ...
      deployed: () => {
        ...
        output +=
          ...
          `   > ${"storage cost:".padEnd(20)} ${data.storagePrice} gwei\n` +
      ...
      // PromiEvents
      hash: () =>
        `   > ${"operation hash:".padEnd(20)} ` + data.transactionHash,
      ...
      postMigrate: () => {
        ...
        output +=
          self.underline(37) +
          "\n" +
          `   > ${"Total cost:".padEnd(15)} ${data.cost.padStart(15)} XTZ\n`;
      ...
      lastMigrate: () => {
        ...
        output +=
          ...
          `> ${"Final cost:".padEnd(20)} ${data.finalCost} XTZ\n`;
